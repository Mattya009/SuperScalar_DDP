...
HD_PWD='C:/lab/4B_Research/SS_DDP/OPC_test/Enable_Flag/Enable_Flag/Enable_Flag.runs/PS_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PS.tcl

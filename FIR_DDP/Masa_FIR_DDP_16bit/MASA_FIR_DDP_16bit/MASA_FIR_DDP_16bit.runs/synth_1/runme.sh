...
HD_PWD='C:/lab/4B_Research/FIR_DDP/Masa_FIR_DDP_16bit/MASA_FIR_DDP_16bit/MASA_FIR_DDP_16bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDP.tcl

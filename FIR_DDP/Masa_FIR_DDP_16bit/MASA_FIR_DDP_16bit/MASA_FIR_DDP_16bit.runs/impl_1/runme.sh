...
HD_PWD='C:/lab/4B_Research/FIR_DDP/Masa_FIR_DDP_16bit/MASA_FIR_DDP_16bit/MASA_FIR_DDP_16bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DDP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DDP.tcl -notrace

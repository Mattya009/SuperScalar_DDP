...
REM
REM Generated by Vivado on Fri Aug 28 19:11:30 +0900 2026
...
echo "xvlog --incr --relax -prj DDP_SIM_vlog.prj"
call xvlog  --incr --relax -prj DDP_SIM_vlog.prj -log xvlog.log

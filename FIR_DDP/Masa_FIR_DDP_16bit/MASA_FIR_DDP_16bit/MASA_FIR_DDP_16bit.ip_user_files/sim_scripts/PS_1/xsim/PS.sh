...
#
# Script generated by Vivado on Tue Aug 25 14:39:45 +0900 2026
...
#
# Usage        : PS.sh
#                PS.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                PS.sh [-rerun]
#                PS.sh [-reset_run]
#                PS.sh [-clean]
#                PS.sh [-reset_log]
...
# script info
echo -e "PS.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./PS.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PS xil_defaultlib.PS xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PS.wdb xsim.dir libdpi.so)
...
Usage: PS.sh [-clean]\n\
Usage: PS.sh [-reset_log]\n\
Usage: PS.sh [-keep_index]\n\

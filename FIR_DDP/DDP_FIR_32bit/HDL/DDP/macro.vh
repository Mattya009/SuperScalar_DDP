...
//FP
`define ALU_LENGTH              138
`define ALU_FLOW_DATA           137:74
`define ALU_WRITE_EN            73
`define ALU_WRITE_DATA          72:57
`define ALU_color_to_CPY        56:35
`define ALU_C                   34
`define ALU_Z                   33
`define ALU_PACKET_ResultData   32:1

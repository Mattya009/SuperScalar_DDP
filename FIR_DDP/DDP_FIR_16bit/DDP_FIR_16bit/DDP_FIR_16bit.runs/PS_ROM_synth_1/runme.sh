...
HD_PWD='C:/lab/4B_Research/FIR_DDP/DDP_FIR_16bit/DDP_FIR_16bit/DDP_FIR_16bit.runs/PS_ROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PS_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PS_ROM.tcl

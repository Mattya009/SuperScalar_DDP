...
HD_PWD='C:/lab/4B_Research/FIR_DDP/DDP_FIR_16bit/DDP_FIR_16bit/DDP_FIR_16bit.runs/MA_DMEM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MA_DMEM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MA_DMEM.tcl

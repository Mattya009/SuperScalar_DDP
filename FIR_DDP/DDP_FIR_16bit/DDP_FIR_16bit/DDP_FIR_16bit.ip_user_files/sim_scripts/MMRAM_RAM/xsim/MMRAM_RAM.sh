...
#
# Script generated by Vivado on Tue Aug 25 17:19:34 +0900 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : MMRAM_RAM.sh
...
#
# Usage        : MMRAM_RAM.sh
#                MMRAM_RAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MMRAM_RAM.sh [-rerun]
#                MMRAM_RAM.sh [-reset_run]
#                MMRAM_RAM.sh [-clean]
#                MMRAM_RAM.sh [-reset_log]
#                MMRAM_RAM.sh [-help]
#
...
# script info
echo -e "MMRAM_RAM.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MMRAM_RAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot MMRAM_RAM xil_defaultlib.MMRAM_RAM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim MMRAM_RAM -key {Behavioral:sim_1:Functional:MMRAM_RAM} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb MMRAM_RAM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MMRAM_RAM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MMRAM_RAM.sh [-help]\n\
Usage: MMRAM_RAM.sh [-step]\n\
Usage: MMRAM_RAM.sh [-lib_map_path]\n\
Usage: MMRAM_RAM.sh [-rerun]\n\
Usage: MMRAM_RAM.sh [-reset_run]\n\
Usage: MMRAM_RAM.sh [-clean]\n\
Usage: MMRAM_RAM.sh [-reset_log]\n\
Usage: MMRAM_RAM.sh [-keep_index]\n\
Usage: MMRAM_RAM.sh [-noclean_files]\n\n\
